namespace ZappyLogger.ColumnizaeLib
{
    ...
    /// ZappyLogger will automatically load a log file in XML mode if the current Columnizer implements 
    /// this interface.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// <br></br>
    /// When in XML mode, ZappyLogger will scan for XML fragmets. These fragments are defined by opening
    ...
    /// is splitted into single lines. These single lines are the lines you will see in ZappyLogger's display.
    /// </para>
    /// <para>
    ...
    /// <ol>
    /// <li>ZappyLogger reads the file and separates it into fragments of XML content using the given 
    ...
    ///     The result is one or more lines of text content. These lines will be the lines ZappyLogger will 'see'
    ...
    public interface ILogLineXmlColumnizer : ILogLineColumnizer
    {
        ...
        /// <summary>
        /// You have to implement this function to provide a configuration for ZappyLogger's XML reader.
        /// </summary>
        /// <returns></returns>
