...
{
    /// <summary>
    /// This callback interface is implemented by ZappyLogger. You can use it e.g. when implementing a
    /// context menu plugin.
    /// </summary>
    public interface IZappyLoggerCallback : ILogLineColumnizerCallback
    {
        #region Public methods

        /// <summary>
        /// Call this function to add a new temporary file tab to ZappyLogger. This may be usefull
        /// if your plugin creates some output into a file which has to be shown in ZappyLogger.
        /// </summary>
        /// <param name="fileName">Path of the file to be loaded.</param>
        /// <param name="title">Title shown on the tab.</param>
        /// <remarks>
        /// The file tab is internally handled like the temp file tabs which ZappyLogger uses for 
