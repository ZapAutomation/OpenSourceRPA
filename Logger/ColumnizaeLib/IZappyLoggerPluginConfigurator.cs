...
namespace ZappyLogger.ColumnizaeLib
{
    ...
    /// by yourself.
    /// </summary>
    public interface IZappyLoggerPluginConfigurator
    {
        ...
        /// 'Embedded' means that the dialog is shown directly in the Settings dialog of ZappyLogger on the
        ...
        /// <summary>
        /// This function is called when ZappyLogger fills the list of plugins in the Settings dialog.
        ...
        /// Don't make the changes permanent here, because the user may click the cancel button of ZappyLogger's 
        ...
        /// <summary>
        /// Called by ZappyLogger if the user clicks the OK button in ZappyLogger's Settings dialog.
        /// Save your temporary copy of the config here.
        /// </summary>
        /// <param name="configDir">The location where ZappyLogger stores its settings.</param>
        void SaveConfig(string configDir);

        /// <summary>
        /// This function is called when ZappyLogger is started and scans the plugin directory.
