namespace ZappyLogger.ColumnizaeLib
{
    ...
    /// content of a log file right before it will be seen by ZappyLogger.
    /// </para>
    /// <para>
    ...
    /// when dropping lines. Dropping a line changes the line count seen by ZappyLogger. That has implications
    ...
    public interface IPreProcessColumnizer
    {
        ...
        /// <param name="lineNum">Line number as seen by ZappyLogger</param>
        ...
        /// When you drop a line, this line is hidden completely from ZappyLogger's log buffers. No chance
        ...
        /// field name retrieval. But then the line is dropped. So the line isn't seen by ZappyLogger.
        ...
        /// of ZappyLogger isn't complete. You cannot make any assumptions about file size or other
