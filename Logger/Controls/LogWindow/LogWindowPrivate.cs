...
namespace ZappyLogger.Controls.LogWindow
{
    public partial class LogWindow
    {
        ...
        {
            ZappyLoggerCallback callback = new ZappyLoggerCallback(this);
       ...
       * =======================================================================*/
        ...
        /// </summary>
        /// <param name="e">The <see cref="HighlightEventArgs"/> instance containing the event data.</param>
        ...
        private void SetDefaultHighlightGroup()
        {
            ...
            //HilightEntry success  = new HilightEntry("passes", DefaultForeColor, Color.Chartreuse, false);
            //group.HilightEntryList.Add(success);
            //this.HilightGroupList
            SetCurrentHighlightGroup("Zappy Audit Log Call");
            //.FindHighlightGroupByFileMask(FileName);
            //if (group != null)
            //{
