...
namespace ZappyLogger.Controls.LogTabWindow
{
    public partial class LogTabWindow
    {
        ...
        private void LogTabWindow_Closing(object sender, CancelEventArgs e)
        {
            ...
            {
                if (ZappyLoggerProxy != null)
                {
                    ZappyLoggerProxy.WindowClosed(this);
                }
                this.Dispose();
            }
        }
        ...
        private void LogTabWindow_DragEnter(object sender, DragEventArgs e)
        {
            ...
            //string s = "Dragging something over ZappyLogger. Formats:  ";
        ...
        {
            Help.ShowHelp(this, "ZappyLogger.chm");
        }
        ...
        private void saveProjectToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            dlg.DefaultExt = "lxj";
            dlg.Filter = "ZappyLogger session (*.lxj)|*.lxj";
            if (dlg.ShowDialog() == DialogResult.OK)
            {
        ...
        private void loadProjectToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            dlg.DefaultExt = "lxj";
            dlg.Filter = "ZappyLogger sessions (*.lxj)|*.lxj";
            if (dlg.ShowDialog() == DialogResult.OK)
            {
