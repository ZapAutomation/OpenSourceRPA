...
{
    /// <summary>
    /// Interface for file system plugins. A file system plugin is responsible for feeding file data to ZappyLogger.
    /// </summary>
    /// <remarks>
    /// ZappyLoggers file handling is done via file system plugins. The selection if the appropriate plugin for a file is based 
    ...
    public interface IFileSystemPlugin
    {
        ...
        /// <summary>
        /// Called from ZappyLogger to determine a file system plugin for a given URI. 
        /// </summary>
        ...
        /// The method is called from ZappyLogger when a file is about to be opened. It's called after <see cref="CanHandleUri"/> was called.
        /// </summary>
