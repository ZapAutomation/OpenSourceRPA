    ...
    public partial class LogWindow
    {
       ...
       */
                ...
                if (bookmark.Text != null && bookmark.Text.Length > 0)
                {
                    if (DialogResult.No ==
                        MessageBox.Show("There's a comment attached to the bookmark. Really remove the bookmark?",
                            "ZappyLogger", MessageBoxButtons.YesNo))
                    {
                        return;
                    }
                }
        ...
        public void DeleteBookmarks(List<int> lineNumList)
        {
            ...
            {
                if (
                    MessageBox.Show("There are some comments in the bookmarks. Really remove bookmarks?", "ZappyLogger",
       ...
       */
        ...
        public void ExportBookmarkList()
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    _logger.Error(e);
                    MessageBox.Show("Error while exporting bookmark list: " + e.Message, "ZappyLogger");
                }
            }
        }
        ...
        public void ImportBookmarkList()
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    _logger.Error(e);
                    MessageBox.Show("Error while importing bookmark list: " + e.Message, "ZappyLogger");
                }
            }
        }
