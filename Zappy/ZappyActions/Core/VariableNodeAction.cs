...
{
                public sealed class VariableNodeAction : TemplateAction , IVariableAction
    {
                public VariableNodeAction()
        {
        ...
        public DynamicProperty<string> EvaluationExpression { get; set; }
