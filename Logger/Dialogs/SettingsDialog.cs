...
namespace ZappyLogger.Dialogs
{
    public partial class SettingsDialog : Form
    {
        ...
        private IZappyLoggerPluginConfigurator selectedPlugin = null;
        ...
        private void FillDialog()
        {
            ...
            this.horizRadioButton.Checked = this.Preferences.timestampControlDragOrientation ==
                                            DateTimeDragControl.DragOrientations.Horizontal;
            this.verticalRadioButton.Checked = this.Preferences.timestampControlDragOrientation ==
                                               DateTimeDragControl.DragOrientations.Vertical;
            this.verticalInvRadioButton.Checked = this.Preferences.timestampControlDragOrientation ==
            ...
            this.sessionSaveOwnDirLabel.Text =
                this.Preferences.saveDirectory != null ? this.Preferences.saveDirectory : "";
            ...
            this.columnizerDataGridView.DataError +=
        ...
        private void FillColumnizerList()
        {
            ...
            DataGridViewComboBoxColumn
                comboColumn = (DataGridViewComboBoxColumn)this.columnizerDataGridView.Columns[1];
            ...
            if (count > 0 && !this.columnizerDataGridView.Rows[count - 1].IsNewRow)
            {
                DataGridViewComboBoxCell comboCell =
                    (DataGridViewComboBoxCell)this.columnizerDataGridView.Rows[count - 1].Cells[1];
        ...
        private void FillHighlightMaskList()
        {
            ...
            {
                DataGridViewComboBoxCell comboCell =
                    (DataGridViewComboBoxCell)this.highlightMaskGridView.Rows[count - 1].Cells[1];
                comboCell.Value = comboCell.Items[0];
            }
        }
        ...
        private void FillPluginList()
        {
            ...
            foreach (IContextMenuEntry entry in PluginRegistry.GetInstance().RegisteredContextMenuPlugins)
            {
                ...
                if (entry is IZappyLoggerPluginConfigurator)
                {
                    (entry as IZappyLoggerPluginConfigurator).StartConfig();
                }
            }
        ...
        private void SavePluginSettings()
        {
            ...
            foreach (IContextMenuEntry entry in PluginRegistry.GetInstance().RegisteredContextMenuPlugins)
            {
                if (entry is IZappyLoggerPluginConfigurator)
                {
                    (entry as IZappyLoggerPluginConfigurator).SaveConfig(ConfigManager.ConfigDir);
                }
            }
            foreach (IKeywordAction entry in PluginRegistry.GetInstance().RegisteredKeywordActions)
            {
        ...
        private void GetCurrentToolValues()
        {
            if (this.selectedTool != null)
            {
                this.selectedTool.name =
                    Util.IsNullOrSpaces(this.toolName.Text) ? this.cmdTextBox.Text : this.toolName.Text;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            {
                this.Preferences.timestampControlDragOrientation =
                    DateTimeDragControl.DragOrientations.InvertedVertical;
            }
            else
            {
        ...
        {
            DataGridViewComboBoxCell comboCell =
                (DataGridViewComboBoxCell)this.columnizerDataGridView.Rows[e.RowIndex].Cells[1];
        ...
        private void pluginListBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (o != null)
            {
                this.selectedPlugin = o as IZappyLoggerPluginConfigurator;
                if (o is IZappyLoggerPluginConfigurator)
                {
        ...
        private void sessionSaveDirButton_Click(object sender, EventArgs e)
        {
            ...
            dlg.Description = "Choose folder for ZappyLogger's session files";
            if (dlg.ShowDialog() == DialogResult.OK)
            {
        ...
        private void importButton_Click(object sender, EventArgs e)
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                FillDialog();
                MessageBox.Show(this, "Settings imported", "ZappyLogger");
            }
        }
