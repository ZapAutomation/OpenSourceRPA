...
{
    internal class ZappyLoggerProxy : MarshalByRefObject, IZappyLoggerProxy
    {
        #region Fields
        ...
        public ZappyLoggerProxy(LogTabWindow logTabWindow)
        {
            AddWindow(logTabWindow);
            logTabWindow.ZappyLoggerProxy = this;
