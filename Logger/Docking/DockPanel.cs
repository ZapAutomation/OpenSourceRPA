    ...
    public partial class DockPanel : Panel
    {
        ...
        internal Form ParentForm
        {
            get
            {
                ...
                {
                    throw new InvalidOperationException("DockPanel_ParentForm_Invalid");
                }
        ...
        public void SetPaneIndex(DockPane pane, int index)
        {
            ...
            if (oldIndex == -1)
            {
                throw new ArgumentException("DockPanel_SetPaneIndex_InvalidPane");
            }
            ...
            if (index < 0 || index > Panes.Count - 1)
            {
                if (index != -1)
                {
                    throw new ArgumentOutOfRangeException("DockPanel_SetPaneIndex_InvalidIndex");
                }
            }
