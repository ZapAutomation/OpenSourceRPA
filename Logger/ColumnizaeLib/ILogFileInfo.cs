...
{
    /// <summary>
    /// Interface which represents a file in ZappyLogger. 'File' could be anything that represents text data to be displayed in ZappyLogger.
    /// </summary>
    public interface ILogFileInfo
    {
        ...
        /// <summary>
        /// The interval (in ms) ZappyLogger should check for file changes. The property is checked by ZappyLogger repeatedly in the loop which
        ...
        /// The caller (ZappyLogger) is responsible for closing the stream.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <remarks>
        /// ZappyLogger will poll this method with the interval returned from PollInterval.
        /// </remarks>
        bool FileHasChanged();
