...
{
    /// <summary>
    /// Implement this interface to execute a self defined action when ZappyLogger detects a 
    ...
    public interface IKeywordAction
    {
        ...
        /// <summary>
        /// Is called when ZappyLogger detects a keyword match which is configured for this plugin.
        ...
        /// the keyword match.
        /// </remarks>
        void Execute(string keyword, string param, IZappyLoggerCallback callback, ILogLineColumnizer columnizer);
