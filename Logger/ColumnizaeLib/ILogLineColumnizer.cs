...
{
    ///<summary>
    /// This interface defines a so-called 'Columnizer' for ZappyLogger.
    /// A columnizer splits a single text line into well defined columns. These columns
    /// are used in the data grid view of ZappyLogger.
    /// <br></br><br></br> 
    ...
    /// some of the features of ZappyLogger (see user documentation for more information).
    /// <br></br><br></br>
    ...
    public interface ILogLineColumnizer
    {
        ...
        /// is added by ZappyLogger and is not handled by columnizers.
        /// </remarks>
        int GetColumnCount();

        /// <summary>
        /// Returns the names of the columns. The returned names are used by ZappyLogger for the column headers in the data grid view.
        ...
        /// </summary>
        /// <remarks>
        /// This function is called by ZappyLogger for every line that has to be drawn in the grid view. The faster your code
        /// handles the splitting, the faster ZappyLogger can draw the grid view content.<br></br>
        /// <br></br>
