...
namespace Zappy.Helpers.NugetManager
{
    public class NuGetPackageManager
    {
        ...
        {
            var provider = Instance.DefaultSourceRepositoryProvider.PackageSourceProvider;
        ...
        public async Task<List<IPackageSearchMetadata>> Search(PackageSource source, bool includePrerelease, string searchString)
        {
        ...
        public async Task<List<PackageSearchItem>> GetLocal(PackageIdentity identity)
        {
        ...
        public async Task<List<IPackageSearchMetadata>> DownloadAndInstall(PackageIdentity identity, bool LoadDlls)
        {
            var result = new List<IPackageSearchMetadata>();
