namespace ZappyLogger.ColumnizaeLib
{
    ...
    /// The Config button in ZappyLogger's columnizer dialog is enabled if a Columnizer implements this interface.
    ...
    public interface IColumnizerConfigurator
    {
        ...
        /// <param name="configDir">The complete path to the directory where ZappyLogger stores its settings. 
        /// You can use this directory, if you want to. Please don't use the file name "settings.dat", because this
        /// name is used by ZappyLogger.
        /// </param>
        /// <remarks>
        ...
        /// <summary>
        /// This function will be called right after ZappyLogger has loaded your Columnizer class. Use this
