...
using ZappyLogger.Classes.Bookmark;
using ZappyLogger.Classes.Filter;
using ZappyLogger.Classes.Highlight;
using ZappyLogger.Classes.Log;
using ZappyLogger.Classes.Persister;
...
namespace ZappyLogger.Controls.LogWindow
{
    public partial class LogWindow : DockContent, ILogPaintContext, ILogView
    {
        ...
        private readonly LogTabWindow.LogTabWindow parentLogTabWin;
        ...
        public LogWindow(LogTabWindow.LogTabWindow parent, string fileName, bool isTempFile,
        ...
        private delegate void ActionPluginExecuteFx(
            string keyword, string param, IZappyLoggerCallback callback, ILogLineColumnizer columnizer);
        ...
        public class ZappyLoggerCallback : ColumnizerCallback, IZappyLoggerCallback
        {
            #region cTor

            public ZappyLoggerCallback(LogWindow logWindow)
                : base(logWindow)
            {
            }
